...
#line 114 "./src/observer/sql/parser/yacc_sql.tab.c"
...
union YYSTYPE
{
#line 102 "./src/observer/sql/parser/yacc_sql.y"
...
#line 236 "./src/observer/sql/parser/yacc_sql.tab.c"
...
static const yytype_int16 yyrline[] =
{
     ...
     246,   252,   260,   274,   284,   304,   307,   320,   328,   338,
     341,   342,   343,   346,   363,   366,   377,   381,   385,   394,
     406,   421,   443,   453,   458,   469,   472,   475,   478,   481,
     485,   488,   496,   503,   515,   520,   531,   534,   548,   551,
     564,   567,   573,   576,   581,   588,   600,   612,   624,   639,
     640,   641,   642,   643,   644,   648,   661,   669,   679,   680
};
#endif
...
#line 1674 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 25:
#line 215 "./src/observer/sql/parser/yacc_sql.y"
         {
...
#line 1682 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 26:
#line 221 "./src/observer/sql/parser/yacc_sql.y"
               {
...
#line 1698 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 28:
#line 233 "./src/observer/sql/parser/yacc_sql.y"
                  {
...
#line 1716 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 30:
#line 246 "./src/observer/sql/parser/yacc_sql.y"
                {
...
#line 1734 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 1749 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 33:
#line 275 "./src/observer/sql/parser/yacc_sql.y"
    {
...
#line 1816 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 341 "./src/observer/sql/parser/yacc_sql.y"
               { (yyval.number)=INTS; }
#line 1840 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 1869 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 1877 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 45:
#line 366 "./src/observer/sql/parser/yacc_sql.y"
                              { 
...
#line 1920 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 49:
#line 395 "./src/observer/sql/parser/yacc_sql.y"
    {
...
#line 1934 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 50:
#line 407 "./src/observer/sql/parser/yacc_sql.y"
    {
...
#line 1975 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 1986 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;

  case 53:
#line 454 "./src/observer/sql/parser/yacc_sql.y"
    {
      (yyval.expression_list) = new std::vector<Expression*>;
      (yyval.expression_list)->emplace_back((yyvsp[0].expression));
    }
#line 1995 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 2040 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 2123 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;

  case 67:
#line 534 "./src/observer/sql/parser/yacc_sql.y"
                               {
      if ((yyvsp[0].rel_attr_list) != nullptr) {
        (yyval.rel_attr_list) = (yyvsp[0].rel_attr_list);
      } else {
...
#line 2177 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 2185 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 2205 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;

  case 75:
#line 589 "./src/observer/sql/parser/yacc_sql.y"
    {
...
#line 2237 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 2269 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 2287 "./src/observer/sql/parser/yacc_sql.tab.c"
  ...
  case 82:
#line 642 "./src/observer/sql/parser/yacc_sql.y"
...
#line 2319 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 2328 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
...
#line 2340 "./src/observer/sql/parser/yacc_sql.tab.c"
    break;
