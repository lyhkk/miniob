...
RC VacuousTrx::update_record(Table *table, Record &record, std::vector<std::string> attr_names, std::vector<Value*> values) {return table->update_record(record, attr_names, values); }
